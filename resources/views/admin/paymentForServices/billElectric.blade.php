    ...
    <div class="hienthi">
        <div class="hienthi-left">
            ...
            <ul>
                ...
                <li>
                    <a class="btn btn-secondary" href="{{route('show-BillE')}}">Phí điện sinh hoạt</a>
                </li>
                <li>
        ...
        <div class="hienthi-right">
            ...
            <br><br>
            <ul>
                <a class="btn btn-outline-secondary" href="{{route('show-BillE-notpaid')}}"><li>Chưa thanh toán</li></a>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('show-BillE-detail', $user -> id)}}"><i class="fa fa-search" style="font-size:20px"></i></a></td>
                        <td>
                            <?php foreach ($bills as $bill)
                            if(($bill -> user_id) == ($user -> id) && $bill -> paid == 0)
                            {
