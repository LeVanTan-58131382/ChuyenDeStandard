    ...
    <div class="hienthi">
        <div class="hienthi-left">
            ...
            <ul>
                ...
                <li>
                    <a class="btn btn-secondary" href="{{route('admin.show-bill', 3)}}">Phí gửi xe</a>
                </li>
            </ul>
        </div>
        <div class="hienthi-right">
            ...
            <br><br>
            <ul>
                <a class="btn btn-outline-secondary" href="{{route('admin.show-bill-notpaid', 3)}}"><li>Chưa thanh toán</li></a>
                <a class="btn btn-outline-secondary" href="{{route('admin.show-bill-paid', 3)}}"><li>Đã thanh toán</li></a>
            </ul>
        </div>
    </div>
    <br>
                                ...
                                @if(($bill -> customer_id) == ($customer -> id))
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif(($bill -> customer_id) == ($customer -> id) && $bill -> paid == 1)
